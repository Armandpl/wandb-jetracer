...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Collect images and upload them to wandb")
    parser.add_argument("dataset_name", type=str)
    parser.add_argument("--nb_imgs", type=int, default=120, help="how many images you want to collect")
    ...
    with wandb.init(project=args.project, config=args, job_type="collect-data", entity=args.entity) as run:
